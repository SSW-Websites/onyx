                    ...
                    >
                      <div
                        className={[
                          ...
                          index === 2
                            ? "min-h-[52px] text-[13.5px] leading-[1.2] sm:min-h-[72px] sm:text-[24px] lg:min-h-[84px] lg:text-[37px] lg:leading-[100.1px]"
                            : "min-h-[52px] text-[13.5px] leading-[1.2] sm:min-h-[60px] sm:text-[18px] lg:min-h-[85px] lg:text-[27.7px] lg:leading-[75.1px]",
                        ].join(" ")}
                      >
                        <span>{item}</span>
                      </div>
