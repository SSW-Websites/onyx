  ...
  return (
    <section className="relative w-full overflow-hidden bg-[linear-gradient(179deg,rgba(59,76,91,1)_0%,rgba(32,46,59,1)_100%)]">
      <div className="relative mx-auto flex min-h-[917px] w-full max-w-[1920px] flex-col px-6 pb-0 pt-20 sm:px-10 lg:px-14 xl:px-16">
        ...
        <header className="relative z-10 grid grid-cols-1 gap-8 pb-8 lg:grid-cols-[minmax(0,809px)_minmax(320px,485px)] lg:items-start lg:justify-between lg:gap-10 lg:pb-24">
          <h2 className="max-w-[809px] text-left [font-family:'Montserrat',Helvetica] text-[38px] font-bold leading-[0.92] tracking-[4px] text-white sm:text-[48px] sm:tracking-[5.2px] lg:text-[61.7px] lg:tracking-[6.79px]">
        ...
        <div className="relative z-10 grid flex-1 grid-cols-1 border border-b-0 border-white/20 sm:grid-cols-2 lg:grid-cols-3">
          ...
          >
            <CardContent className="flex min-h-[180px] flex-1 items-center p-6 sm:min-h-[280px] sm:p-8 lg:min-h-[380px] lg:p-10">
              <h3
          ...
          <Card className="flex h-full flex-col rounded-none border-x border-y-0 border-[#ebf3ff] bg-[#172734] shadow-none sm:col-span-2 lg:col-span-1">
            <CardContent className="relative flex min-h-[280px] flex-1 overflow-hidden p-0 sm:min-h-[360px] lg:min-h-[380px]">
              <img
        ...
        <div className="relative z-10 mt-8 flex justify-start lg:hidden">
          <Button
            type="button"
            onClick={() => document.getElementById("growth-team-story")?.scrollIntoView({ behavior: "smooth" })}
            className="h-auto min-h-20 w-full max-w-[485px] rounded-none bg-white px-6 py-6 text-black hover:bg-gray-50 active:bg-gray-100 transition-colors"
          >
            <span className="w-full [font-family:'Montserrat',Helvetica] text-center text-[18px] font-bold leading-[22.4px] tracking-[2px] text-black sm:text-[20px]">
              BOOK YOUR INTERVIEW
            </span>
          </Button>
        </div>
